...
export default function BottomNav({ activeTab, onSwitchTab }) {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-slate-900/95 border-t border-slate-800 backdrop-blur-xl">
      <div className="flex items-center justify-around py-2 px-2">
        {tabs.map(tab => {
          ...
          return (
            ...
            >
              <i className={`fa-solid ${tab.icon} text-lg ${isActive ? 'text-blue-400' : ''}`}></i>
